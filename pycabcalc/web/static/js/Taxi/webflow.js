...
Webflow.require('ix').init([
  {"slug":"button-hover","name":"Button hover","value":{"style":{"opacity":1},"triggers":[{"type":"hover","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":1.05}],"stepsB":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":1}]},{"type":"load","preload":true,"stepsA":[{"opacity":1,"wait":500,"transition":"opacity 500ms ease 0ms"},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}}
]);
